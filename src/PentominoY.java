...
public class PentominoY extends Pentomino{

    public PentominoY(){
        create(Color.decode("#663300"));
    }
    ...
    public void setXY(int x, int y) {
        ...
        piece[4].x = piece[0].x;
        piece[4].y = piece[0].y + 2 * PentominoBlocks.SIZE;
    }
    ...
    public void getDirection1() {
        ...
        tempPiece[4].y = piece[0].y + 2 * PentominoBlocks.SIZE;
        direction = 1;
    }
